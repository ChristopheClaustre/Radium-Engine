...
namespace PointyCloudPlugin {
    ...
    {
    public:
        APSSTask(Cuda::APSS* apss, std::shared_ptr<Ra::Engine::Mesh> mesh, const Ra::Engine::Camera* camera, Scalar splatRadius) :
            m_apss(apss), m_mesh(mesh), m_camera(camera), m_splatRadius(splatRadius) {}
        ~APSSTask() {}
