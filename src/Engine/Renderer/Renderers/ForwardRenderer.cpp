...
namespace Ra
{
    namespace Engine
    {
        ...
        ForwardRenderer::~ForwardRenderer() { ShaderProgramManager::destroyInstance(); }
        ...
        {
            m_depthShader = m_assetMgr->shaderProgram(
                m_assetMgr->createShaderProgram("../Shaders/DepthMap.vert.glsl",
                                                "../Shaders/DepthMap.frag.glsl"));
            m_ambientPassShader = m_assetMgr->shaderProgram(
                m_assetMgr->createShaderProgram("../Shaders/BlinnPhong.vert.glsl",
                                                "../Shaders/DepthAmbientPass.frag.glsl"));
            m_finalComposeShader = m_assetMgr->shaderProgram(
                m_assetMgr->createShaderProgram("../Shaders/Basic2D.vert.glsl",
                                                "../Shaders/FinalCompose.frag.glsl"));
#ifndef NO_TRANSPARENCY
            m_litOITShader = m_assetMgr->shaderProgram(
                m_assetMgr->createShaderProgram("../Shaders/BlinnPhong.vert.glsl",
                                                "../Shaders/LitOIT.frag.glsl"));
            m_unlitOITShader = m_assetMgr->shaderProgram(
                m_assetMgr->createShaderProgram("../Shaders/Plain.vert.glsl",
                                                "../Shaders/UnlitOIT.frag.glsl"));
            m_composeOITShader = m_assetMgr->shaderProgram(
                m_assetMgr->createShaderProgram("../Shaders/Basic2D.vert.glsl",
        ...
        void ForwardRenderer::initBuffers()
        {
            ...
            m_postprocessFbo.reset(
                new FBO(FBO::Component_Color | FBO::Component_Depth, m_width, m_height));

            // Render pass
            m_textures[RendererTextures_Depth] =
                m_assetMgr->texture(m_assetMgr->createTexture("Depth"));
            m_textures[RendererTextures_HDR] =
                m_assetMgr->texture(m_assetMgr->createTexture("HDR"));
            m_textures[RendererTextures_Normal] =
                m_assetMgr->texture(m_assetMgr->createTexture("Normal"));
            m_textures[RendererTextures_Diffuse] =
                m_assetMgr->texture(m_assetMgr->createTexture("Diffuse"));
            m_textures[RendererTextures_Specular] =
                m_assetMgr->texture(m_assetMgr->createTexture("Specular"));
            m_textures[RendererTextures_OITAccum] =
                m_assetMgr->texture(m_assetMgr->createTexture("OIT Accum"));
            m_textures[RendererTextures_OITRevealage] =
                m_assetMgr->texture(m_assetMgr->createTexture("OIT Revealage"));
...
// FIXME(charly) Do we want ui too  ?
        ...
        void ForwardRenderer::renderInternal(const RenderData& renderData)
        {
            ...
            const Core::Colorf clearOnes =
                Core::Colors::FromChars<Core::Colorf>(255, 255, 255, 255);
